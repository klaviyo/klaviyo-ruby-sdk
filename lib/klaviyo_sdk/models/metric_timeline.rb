  ...
  class MetricTimeline
    ...
    def list_invalid_properties
      ...
      if !@data.nil? && @data.length < 0
        invalid_properties.push('invalid value for "data", number of items must be greater than or equal to 0.')
      end
    ...
    def data=(data)
      ...
      if !data.nil? && data.length < 0
        fail ArgumentError, 'invalid value for "data", number of items must be greater than or equal to 0.'
      end
