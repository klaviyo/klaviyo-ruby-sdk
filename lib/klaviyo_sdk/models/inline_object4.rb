  ...
  class InlineObject4
    ...
    def list_invalid_properties
      ...
      if @profiles.length > 100
        invalid_properties.push('invalid value for "profiles", number of items must be less than or equal to 100.')
      end

      if @profiles.length < 0
        invalid_properties.push('invalid value for "profiles", number of items must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @profiles.length > 100
      return false if @profiles.length < 0
      true
    end
    ...
    def profiles=(profiles)
      ...
      if profiles.length > 100
        fail ArgumentError, 'invalid value for "profiles", number of items must be less than or equal to 100.'
      end

      if profiles.length < 0
        fail ArgumentError, 'invalid value for "profiles", number of items must be greater than or equal to 0.'
      end
